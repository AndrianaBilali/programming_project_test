...
public class AppTest{
    ...
    @Test
    public void testValidateRecipe_InvalidQuantity() {
        // Creating an invalid JSON recipe string with negative quantity for testing
        String invalidRecipeJson = "{\"recipe\": {\"ingredients\": [{\"name\": \"Flour\", \"quantity\": -200}], \"steps\": [\"Step 1: Mix flour\"]}}";

        boolean isValid = obj.validateRecipe(invalidRecipeJson);

        assertFalse(isValid);
    }

    @Test
    public void testValidateRecipe_EmptyStep() {
        // Creating an invalid JSON recipe string with an empty step for testing
        String invalidRecipeJson = "{\"recipe\": {\"ingredients\": [{\"name\": \"Flour\", \"quantity\": 200}], \"steps\": [\"\"]}}";
