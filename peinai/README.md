...
**3) Οδηγίες Χρήσης:**
Η κύρια μέθοδος της εφαρμογής περιλαμβάνει τις εξής λειτουργίες:
...
Το αποθετήριο περιέχει 5 κλαδιά:
...
- main: Περιέχει όλες τις κλάσεις μετά το merge των κλαδιών

**Κάθε κλαδί περιέχει τα αντίστοιχα JUnit tests των κλάσεών του.**
